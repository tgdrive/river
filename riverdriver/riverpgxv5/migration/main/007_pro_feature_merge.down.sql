...
DROP FUNCTION IF EXISTS /* TEMPLATE: schema */river_job_get_available_limited_ids(text, timestamptz, integer, integer, integer, integer, text, text[], text[], integer[], text[], boolean);
